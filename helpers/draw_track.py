...
while True:
    ...
    button_pos = (10, 10)
    is_button_hovered = button_pos[0] <= mouse_pos[0] <= button_pos[0] + 100 and button_pos[1] <= mouse_pos[1] <= \
                        button_pos[1] + 30

    save_button_pos = (1100, 10)
    is_save_button_hovered = save_button_pos[0] <= mouse_pos[0] <= save_button_pos[0] + 100 and save_button_pos[1] <= mouse_pos[1] <= \
